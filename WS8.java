...
public class WS8 extends Frame implements ActionListener, Runnable
{
	DatagramSocket D;
	...
	{
		Panel P1 = new Panel();
		P1.add(new Label("sent messages here (input \"exit\" to exit)"));
		P1.add(T2);
		Panel P2 = new Panel();
	...
	public void run()
	{
		try{
				...
				while(true)
				{
					...
					T1.append(Pac.getAddress() + " WC8 says: " + str2 + "\n");
				}
		}
		catch(Exception e3){}
	}
